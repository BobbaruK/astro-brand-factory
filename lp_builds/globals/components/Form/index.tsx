...
const Form = ({ componentProps, id, button, ...restProps }: Props) => {
  ...
  return (
    <form
      {...restProps}
      className={`registerForm w-full ${restProps.className || ""}`}
      id={id}
    >
      <div className="registerFormInner">
        ...
        <div className="form-control countryWrapper">
          <div className="field">
            ...
            <div className="input">
              <select
                id={`${id}-country`}
                className="country-select flex h-9 h-[40px] w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1"
                name="country"
              ></select>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        {(componentProps.lpType == "classic" ||
          componentProps.lpType == "endorsed") && (
          <div className="form-control agreementWrapper agreementWrapperClassic">
            <div className="field">
              <input
                type="checkbox"
                id={`${id}-agreementClassic`}
                name="agreementClassic"
                defaultChecked
              />
        ...
        {(componentProps.lpType == "esma" ||
          componentProps.lpType == "outbrain") && (
          <>
            <div className="form-control agreementWrapper agreementWrapperEsma agree1ESMA">
              <div className="field">
                <input
                  type="checkbox"
                  id={`${id}-agreement1ESMA`}
                  name="agreement1ESMA"
                  defaultChecked
                />
                <Label
                  htmlFor={`${id}-agreement1ESMA`}
                  className="agreement"
                  dangerouslySetInnerHTML={{
                    __html: translations.agree1ESMA[componentProps.lang],
                  }}
                />
              </div>
              <div className="error" />
            ...
            <div className="form-control agreementWrapper agreementWrapperEsma agree2ESMA">
              <div className="field">
                <input
                  type="checkbox"
                  id={`${id}-agreement2ESMA`}
                  name="agreement2ESMA"
                  defaultChecked
                />
                <Label
                  htmlFor={`${id}-agreement2ESMA`}
                  className="agreement"
                  dangerouslySetInnerHTML={{
                    __html: translations.agree2ESMA[componentProps.lang],
                  }}
                />
              </div>
              <div className="error" />
